...
describe("getForMonth", () => {
  beforeEach(() => {
    ...
    txService.create(tx({ amount: 200, categoryId: foodId, type: "expense", date: "2026-03-05" }));
    txService.create(tx({ amount: 100, categoryId: foodId, type: "expense", date: "2026-03-20" }));
    txService.create(
      tx({ amount: 250, categoryId: transportId, type: "expense", date: "2026-03-10" })
    );
    txService.create(tx({ amount: 50, categoryId: foodId, type: "income", date: "2026-03-15" }));
  });
...
describe("getHistory", () => {
  it("returns one point per month", () => {
    budgetService.set(SetBudgetSchema.parse({ categoryId: foodId, month: "2026-03", amount: 500 }));
    txService.create(tx({ categoryId: foodId, amount: 200, type: "expense", date: "2026-03-10" }));
